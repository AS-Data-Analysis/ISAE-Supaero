function sldros_modeswitch(bh, switch_mode)
%SLDROSEXCB_MODESWITCH(buttonHandle, switch_mode) Switch Simulink.
%  SLDROSEXCB_MODESWITCH switches a Simulink
