function [water_level] = drone2d_animate(drone,t,r,theta,gamma)
%DRONE2D_ANIMATE Creates an animation of trajectory and returns water
% level
%
%   INPUTS:
%     - drone: structure containing drone physical parameters. In this
%     function, the relevant parameters are:
%       - drone.l: pendulum lenght in m (for drawing purposes only)
%       - drone.ld: drone lenght in m (for drawing purposes only)
